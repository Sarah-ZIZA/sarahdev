...
<head>
    ...
    <link rel="stylesheet" href="../commandes/Styles.css" />
    ...
    <header>
        ...
        <section id="main">
            ...
            <form id="patientForm" action="insertion.php" method="POST">
                <input type="hidden" name="form_origin" value="formulaire.php?modal=true">
                ...
                <div class="page" id="page2">
                    ...
                    <section class="forms">
                        ...
                        <div>
                            ...
                            <input class="input" type="text" name="Cp" id="Cp" minlength="5" maxlength="5"
                                pattern="[0-9]*" onfocusout="updateVille(this)" required>
                ...
                <div class="page" id="page3">
                    ...
                    <div>
                        ...
                        <section class="forms">
                            ...
                            <div>
                                <label for="prénom">Prénom</label><br>
                                <input class="input" type="text" name="Prénom_confiance"
                                    pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s'-]+" required>
                    ...
                    <section class="forms">
                        ...
                        <div>
                            <label for="Num_Sociale">Numéro de sécurité sociale
                                <span>*</span></label><br>
                            <input class="input" id="num_secu_sociale" type="text" name="Sécurité_sociale"
                                minlength="15" maxlength="15" title="Numéro de sécurité sociale français valide"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                document.getElementById("btnOui").addEventListener("click", function () {
                    ...
                    setTimeout(() => {
                        window.open("../pdf.php", "_blank"); // Redirige après une courte pause
