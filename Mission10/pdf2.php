...
if (!isset($_GET['id_patient'])) {
    die("Aucun ID de patient fourni.");
}

$id_patient = intval($_GET['id_patient']); // sécurité

$stmt = mysqli_prepare($db, "SELECT patient.nom, patient.prénom, patient.num_sécu, hospitalisation.date_hos, hospitalisation.heure, professionnels.Nom, services.service 
FROM patient
...
mysqli_stmt_bind_param($stmt, "i", $id_patient);
mysqli_stmt_execute($stmt);
$rep = mysqli_stmt_get_result($stmt);
